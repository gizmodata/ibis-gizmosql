...
- **Flight SQL**: All SQL is executed over Arrow Flight SQL. The ADBC driver (`adbc-driver-gizmosql>=2.0.0`) automatically detects DDL/DML and executes immediately — just use `cursor.execute()` for everything.
